                                ...
                                <div className="col-lg-4 d-flex flex-column">
                                    ...
                                    <div className="flex-grow-1" style={{opacity: controlsDisabled ? 0.6 : 1, pointerEvents: controlsDisabled ? 'none' : 'auto'}}>
                                        ...
                                        <div className="accordion" id="editorControlsAccordion">
                                            {/* Resize */}
                                             <div className="accordion-item">
                                                <h2 className="accordion-header">
                                                    <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseResize" aria-expanded="true">
                                                        <i className="bi bi-aspect-ratio me-2"></i>Resize
                                                    </button>
                                                </h2>
                                                <div id="collapseResize" className="accordion-collapse collapse show" data-bs-parent="#editorControlsAccordion">
                                            ...
                                            <div className="accordion-item">
                                                <h2 className="accordion-header">
                                                    <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseProperties" aria-expanded="true">
                                                       <i className="bi bi-card-text me-2"></i>Image Properties
                                                    </button>
                                                </h2>
                                                <div id="collapseProperties" className="accordion-collapse collapse show" data-bs-parent="#editorControlsAccordion">
                                                    <div className="accordion-body">
                                                        {!imageToEdit && (
                                                            <div className="mb-3">
